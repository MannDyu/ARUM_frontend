...
//             onPress={() => {
//               if (selected !== null) {
//                 navigation.navigate('RecordDiary', { selectedTags: [], selectedEmotionIndex: selected });
//               }
//             }}
...
//           onClose={onClose}
//           index={selected}
//           onSelected={function (emotion: string | null, tags: string[], emotionIndex: number): void {
...
export default function Diary() {
  ...
  const handleSelected = (emotion: string | null, tags: string[], emotionIndex: number) => {
    setSelected(emotionIndex);
  ...
  return (
    <View style={{ backgroundColor: '#FDFDED' }}>
      ...
      <View style={styles.selectContainer}>
        ...
        <DiaryEmotionDrawer
          selectedEmotion={selected !== -1 ? titles[selected] : null}
          isVisible={bottomSheetVisible}
          onClose={onClose}
          index={selected}
